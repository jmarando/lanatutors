...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const testTutors = [
      ...
      { name: 'Sarah Mwangi', subjects: ['Mathematics', 'Physics'], school: 'University of Nairobi', curriculum: ['IGCSE', 'IB'], rate: 2000, exp: 8, tier: 'gold' },
      ...
      { name: 'Grace Wanjiru', subjects: ['English', 'Literature'], school: 'Strathmore University', curriculum: ['IGCSE', 'IB'], rate: 2000, exp: 7, tier: 'gold' },
      ...
      { name: 'Michael Otieno', subjects: ['Physics', 'Mathematics'], school: 'University of Nairobi', curriculum: ['IGCSE', 'IB'], rate: 2000, exp: 9, tier: 'gold' },
      { name: 'Daniel Kipchoge', subjects: ['Computer Science', 'Mathematics'], school: 'Strathmore University', curriculum: ['IGCSE', 'IB'], rate: 2000, exp: 8, tier: 'gold' },
      { name: 'Robert Maina', subjects: ['Economics', 'Business'], school: 'Kenyatta University', curriculum: ['IB', 'A-Level'], rate: 2000, exp: 11, tier: 'gold' },
      { name: 'Thomas Kiptoo', subjects: ['Chemistry', 'Physics'], school: 'University of Nairobi', curriculum: ['IGCSE', 'IB'], rate: 2000, exp: 8, tier: 'gold' },
      
      // SILVER TIER tutors - 3-5 years, good ratings, mix of curricula
      { name: 'Mary Akinyi', subjects: ['Kiswahili', 'CRE'], school: 'Moi University', curriculum: ['CBC', '8-4-4'], rate: 1750, exp: 4, tier: 'silver' },
      { name: 'John Kariuki', subjects: ['History', 'Geography'], school: 'Egerton University', curriculum: ['CBC', 'IGCSE'], rate: 1750, exp: 5, tier: 'silver' },
      { name: 'Faith Njeri', subjects: ['Business Studies', 'Economics'], school: 'Strathmore University', curriculum: ['IGCSE', 'CBC'], rate: 1750, exp: 5, tier: 'silver' },
      { name: 'Lucy Wairimu', subjects: ['Biology', 'Chemistry'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1750, exp: 4, tier: 'silver' },
      { name: 'Catherine Adhiambo', subjects: ['French', 'English'], school: 'University of Nairobi', curriculum: ['CBC', 'IGCSE'], rate: 1750, exp: 5, tier: 'silver' },
      { name: 'Susan Njoki', subjects: ['Mathematics', 'Statistics'], school: 'Strathmore University', curriculum: ['IGCSE', 'CBC'], rate: 1750, exp: 5, tier: 'silver' },
      { name: 'Margaret Nyawira', subjects: ['Literature', 'English'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1750, exp: 5, tier: 'silver' },
      { name: 'Francis Githinji', subjects: ['Business Studies', 'Mathematics'], school: 'Strathmore University', curriculum: ['CBC', 'IGCSE'], rate: 1750, exp: 5, tier: 'silver' },
      
      // BRONZE TIER tutors - newer tutors, building experience
      { name: 'James Mutua', subjects: ['Mathematics', 'Physics'], school: 'JKUAT', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Elizabeth Chebet', subjects: ['English', 'Kiswahili'], school: 'Moi University', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Anne Wambui', subjects: ['Art', 'Design'], school: 'Egerton University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Joseph Kiprotich', subjects: ['Agriculture', 'Biology'], school: 'Moi University', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Jane Nyambura', subjects: ['Music', 'Drama'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Patrick Owino', subjects: ['Physical Education', 'Biology'], school: 'JKUAT', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Rose Mumbua', subjects: ['Geography', 'History'], school: 'Egerton University', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'George Omondi', subjects: ['Computer Science', 'ICT'], school: 'Strathmore University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Samuel Kuria', subjects: ['Mathematics', 'Economics'], school: 'JKUAT', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Joyce Jepkoech', subjects: ['Biology', 'Agriculture'], school: 'Moi University', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Anthony Njuguna', subjects: ['Physics', 'Computer Science'], school: 'University of Nairobi', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Mercy Awino', subjects: ['Kiswahili', 'English'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Esther Chepkoech', subjects: ['Chemistry', 'Biology'], school: 'Egerton University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Kevin Odongo', subjects: ['History', 'CRE'], school: 'Moi University', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Nancy Wangari', subjects: ['Mathematics', 'Physics'], school: 'JKUAT', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Vincent Koech', subjects: ['English', 'Literature'], school: 'University of Nairobi', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Beatrice Nduta', subjects: ['Geography', 'Business'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Dennis Kiplagat', subjects: ['Computer Science', 'Mathematics'], school: 'Strathmore University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Christine Moraa', subjects: ['Biology', 'Chemistry'], school: 'Egerton University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Brian Mulwa', subjects: ['Economics', 'Mathematics'], school: 'JKUAT', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Phyllis Jepkemoi', subjects: ['French', 'English'], school: 'Moi University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Eric Ndirangu', subjects: ['Physics', 'Mathematics'], school: 'University of Nairobi', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Alice Atieno', subjects: ['Art', 'Music'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Martin Rotich', subjects: ['Agriculture', 'Biology'], school: 'Egerton University', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Violet Wanjiku', subjects: ['English', 'Kiswahili'], school: 'Strathmore University', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Charles Kemboi', subjects: ['Computer Science', 'ICT'], school: 'JKUAT', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Priscilla Anyango', subjects: ['Mathematics', 'Statistics'], school: 'University of Nairobi', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Stephen Kamande', subjects: ['Chemistry', 'Physics'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Rebecca Chepkurui', subjects: ['History', 'Geography'], school: 'Moi University', curriculum: ['CBC', '8-4-4'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Wilson Onyango', subjects: ['Business Studies', 'Economics'], school: 'Strathmore University', curriculum: ['8-4-4', 'CBC'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Helen Waweru', subjects: ['Biology', 'Chemistry'], school: 'Egerton University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Edwin Kimani', subjects: ['Mathematics', 'Computer Science'], school: 'JKUAT', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
      { name: 'Caroline Jelimo', subjects: ['English', 'Literature'], school: 'University of Nairobi', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 3, tier: 'bronze' },
      { name: 'Kenneth Macharia', subjects: ['Physics', 'Mathematics'], school: 'Kenyatta University', curriculum: ['CBC', 'IGCSE'], rate: 1500, exp: 2, tier: 'bronze' },
    ]
